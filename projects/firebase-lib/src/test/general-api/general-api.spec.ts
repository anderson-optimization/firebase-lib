...
describe('General Resource Api', () => {
  ...
  beforeAll(async () => {
    ...
    await resources.teams.set(null, teamsData);
  });
  ...
  describe('updatePathTemplate()', () => {
    it(`is further tested in its own Variable Resource Paths section`, () => {});
  })
});
